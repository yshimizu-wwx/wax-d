...
"[project]/src/lib/calculator/priceCalculator.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function fetchProjects() {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('projects').select('*').eq('status', 'open').order('created_at', {
        ascending: false
    });
    if (error) {
...
async function fetchActiveProject() {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('projects').select('*').eq('status', 'open').eq('is_closed', false).order('created_at', {
        ascending: false
    }).limit(1).single();
    if (error) {
...
async function fetchCampaignTotalArea(campaignId) {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('bookings').select('area_10r').eq('campaign_id', campaignId).neq('status', 'canceled');
    if (error) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$calculator$2f$priceCalculator$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/calculator/priceCalculator.ts [app-ssr] (ecmascript)");
...
function Home() {
    ...
    const [totalCampaignArea, setTotalCampaignArea] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(0);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        async function loadProject() {
            ...
            if (activeProject) {
                const totalArea = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchCampaignTotalArea"])(activeProject.id);
    ...
    const handleFormSubmit = async (formData)=>{
        ...
        const validation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$calculator$2f$priceCalculator$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calculateCurrentUnitPrice"])(pricing, simulatedTotalArea);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ab3b05b1._.js.map