...
async function fetchProjects() {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('projects').select('*');
    if (error) {
...
async function fetchActiveProject() {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('projects').select('*').eq('is_closed', false).order('created_at', {
        ascending: false
    }).limit(1).single();
    if (error) {
...
function Home() {
    ...
    const handleFormSubmit = async (formData)=>{
        ...
        const validation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$calculator$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateCurrentUnitPrice"])(project, area10r);
...
_s(Home, "8+UopqSMyL4okD30284lrmyAKDM=");
_c2 = Home;
var _c, _c1, _c2;
...
//# sourceMappingURL=src_3385822e._.js.map